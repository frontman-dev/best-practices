...
export function PerformanceIcon({ color }: { color?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512" fill={color}>
      <path d="M344 256l-84.4 64.2c-1.2-.1-2.4-.2-3.6-.2-17.7 0-32 14.3-32 32s14.3 32 32 32 32-14.3 32-32c0-1.2-.1-2.4-.2-3.6L352 264l-8-8z" />
